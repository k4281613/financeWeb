    ...
    export default {
        ...
        data() {
            return {
                ...
                shMarketTablAbels: [
                    {name: '美股一览', value: 'us'},
                    {name: 'GICS行业', value: 'gisc'},
                    {name: '明星股', value: 'famous'},
                    {name: '中国概念股', value: 'zggng'},
                    {name: '上市预告', value: 'ssyg'},
                    {name: '新上市公司', value: 'xssgs'},
                ],
                shname: '',
                ths: [],
                shdata: [],
        ...
        computed: {
            conditiondisabled() {
                return (this.value == 'gisc' ) ? true : false
            }
        },
        methods: {
            //行业变化
            ...
            handleClick(val) {
                ...
                if (category == 'gisc') this.activeOption = '403010';
            },
            getshmarket(category, page, addition) {
                this.axios.post('/usmarket', {
                    category: category,
                    page: page,
                    addition: addition
                }).then(res => {
        ...
        mounted() {
            this.getshmarket('us', 1, this.addition)
        }
    }
</script>
<style>
